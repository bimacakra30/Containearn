    ...
    <div class="app-shell">
        <div class="app-grid">
            ...
            <main class="app-main fade-in">
                    ...
                    <div class="grid gap-8 lg:grid-cols-[minmax(0,1fr),360px]">
                        ...
                        <div class="grid gap-3 sm:grid-cols-3">
                            <div class="stat-card">
                                ...
                                <p class="mt-3 text-3xl font-semibold text-slate-900">{{ $courseCount }}</p>
                            </div>
                            <div class="stat-card">
                                <p class="eyebrow">Modules</p>
                                <p class="mt-3 text-3xl font-semibold text-slate-900">{{ $moduleCount }}</p>
                            </div>
                            <div class="stat-card">
                                <p class="eyebrow">Questions</p>
                                <p class="mt-3 text-3xl font-semibold text-slate-900">{{ $questionCount }}</p>
                            </div>
                        </div>
                    </div>
                </header>
                ...
                <section
                    x-data="{ open: @js($createCourseOpen) }"
                ...
                >
                    <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                        ...
                        <button
                            ...
                            @click="open = !open"
                            class="btn-primary">
                            <span x-text="open ? 'Close Form' : 'Add Course'"></span>
                        </button>
                    </div>
                    ...
                    <form
                        ...
                        class="surface-muted grid gap-4 p-5 md:grid-cols-2"
                    >
                        @csrf
                                    ...
                                    >
                                        ...
                                        >
                                            <form
                                                ...
                                                class="surface-subtle grid gap-4 p-5 md:grid-cols-2"
                                            >
                                                @csrf
                                                @method('PATCH')
                                            ...
                                            <form
                                                ...
                                                class="surface-subtle grid gap-4 p-5"
                                            >
                                                @csrf
                                                ...
                                                @forelse ($module->questions as $question)
                                                    ...
                                                    >
                                                        <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                                                            ...
                                                            <div class="w-full space-y-3 lg:max-w-md">
                                                                ...
                                                                <div class="flex flex-wrap justify-end gap-2">
                                                                    <button
                                                                        type="button"
                                                                        @click="questionEditOpen = !questionEditOpen"
                                                                        class="btn-secondary px-4 py-2 text-xs">
                                                                        Edit
                                                                    </button>
                                                                    <button
                                                        ...
                                                        <form
                                                            ...
                                                            class="mt-4 grid gap-4 border-t border-slate-200 pt-4"
                                                        >
                                                            @csrf
                                                            @method('PATCH')
