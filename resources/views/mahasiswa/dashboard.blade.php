        ...
        <div class="grid gap-6 lg:gap-8 lg:grid-cols-[280px,1fr]">
            ...
            <main class="space-y-6 fade-in">
                <header class="glass rounded-[28px] p-6 sm:p-8">
                    ...
                    <h1 class="mt-3 font-display text-3xl sm:text-4xl text-slate-900">
                ...
                <section class="glass rounded-2xl p-6 sm:p-7">
                    ...
                    <div class="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                        <div class="rounded-2xl border border-slate-200 bg-white p-5">
                            <p class="text-xs uppercase tracking-[0.2em] text-slate-400">Practicum</p>
                            <h3 class="mt-3 font-display text-2xl text-slate-900">Practicum Content</h3>
                            <p class="mt-3 text-sm leading-7 text-slate-600">
                                Access the practicum modules and continue your learning activities in the platform.
                            </p>
                        </div>
